...
void forward(int dist, int *hpos, int *vpos, int *aim); // Forward
void up(int dist, int *aim); // Up
void down(int dist, int *aim); // Down 
...
void forward(int dist, int *hpos, int *vpos, int *aim)
{
    *hpos = *hpos + dist;
    *vpos = *vpos + *aim * dist; 
}

void up(int dist, int *aim)
{
    *aim = *aim - dist;
}

void down(int dist, int *aim)
{
    *aim = *aim + dist;
}